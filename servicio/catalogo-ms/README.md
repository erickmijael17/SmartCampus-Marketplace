...
|---|---|---|
| Catalogo | Dinámico (`0`) | 8082 |
| MySQL | 3381 | 3382 |
| Config Server | 18888 | 28888 |
| Registry Server (Eureka) | 18761 | 28761 |
| Gateway | 18080 | 28082 |
...
|---|---|---|---|---|---:|
| DEV | `mvn spring-boot:run` | Docker/local | Config Server DEV | Registry DEV | Dinámico (`0`) |
...
```text
http://localhost:18888/catalogo/dev
```
...
```text
http://localhost:18080/catalogo-ms/swagger-ui/index.html
```

Endpoint de instancia (vía Gateway):

```text
http://localhost:18080/api/v1/catalogo/instancia
```
